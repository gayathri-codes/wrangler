...
/**
 * Collection of useful expression functions made available in the context of an
 * expression.
 *
 * set-column column datetime:CurrentDate() set-column :column exp:{
 * datetime:CurrrentDate() }
 */
public final class DateAndTime {
	private static final DateTimeFormatter DATE_TIME_FORMAT = new DateTimeFormatterBuilder()
			...
			.appendValue(ChronoField.MINUTE_OF_HOUR, 2).appendLiteral(':').appendValue(ChronoField.SECOND_OF_MINUTE, 2)
	...
	/**
	 * Return the {@link LocalDate} the string represents. If the string is null,
	...
	/**
	 * Return the {@link LocalTime} the string represents. If the string is null,
	 * this method will return null.
	 */
	...
	/**
	 * Return the {@link LocalDateTime} the string represents. If the string is
	...
	/**
	 * Returns a date object by adding an integer to a current date. If this integer
	 * is null, current date will be returned. The integer can be negative to return
	 * a date that is earlier than the current date.
	 *
	...
	/**
	 * Returns a date object by adding an integer to a baseline date. If this
	 * integer is null, baseline date will be returned. The integer can be negative
	 * to return a date that is earlier than the baseline date. If baseline is null,
	 * the current date will be used. If days is null, it will be treated as 0.
	 *
	...
	/**
	 * Creates a {@link LocalDate} from the components year, month, and day. If any
	 * input is null, null will be returned.
	 *
	...
	/**
	 * Returns a date from the given Julian day number. The day number will be
	 * treated as 0 if it is null.
	 *
	...
	/**
	 * Returns the given date, with offsets applied from the given year offset,
	 * month offset, and day of month offset. offsets are given as three separate
	 * values. The offset values can each be positive, zero, or negative. If base
	 * line is null, null will be returned. If the offset is null, it will be
	 * treated as 0.
	 *
	 ...
	 */
	public static LocalDate DateOffsetByComponents(LocalDate baseline, Integer yearOffset, Integer monthOffset,
			Integer daysOffset) {
		return baseline == null ? null
				: baseline.plusYears(yearOffset == null ? 0 : yearOffset.longValue())
						.plusMonths(monthOffset == null ? 0 : monthOffset.longValue())
						.plusDays(daysOffset == null ? 0 : daysOffset.longValue());
	}

	/**
	 * Returns the number of days from the source date to the given date. If any
	 * date is null, null will be returned.
	 *
	...
	/**
	 * Returns the number of days in the month in the given base date. If date is
	...
	/**
	 * Returns the number of days in the year in the given base date. If date is
	 * null, null will be returned.
	 *
	 * @param date date of {@link LocalDate} type.
	...
	/**
	 * Returns the given date offset by the given number of days. The offset value
	 * can be positive, zero, or negative. If date is null, null will be returned.
	...
	/**
	 * Returns a Julian day number from the given date. If date is null, null will
	 * be returned.
	 *
	...
	/**
	 * Returns the Nanosecond portion of a time. If time is null, null will be
	 * returned.
	 *
	 * @param time of {@link LocalTime} type.
	...
	/**
	 * Returns the microsecond portion of a time. If time is null, null will be
	 * returned.
	 *
	 * @param time of {@link LocalTime} type.
	...
	/**
	 * Returns the millisecond portion of a time. If time is null, null will be
	 * returned.
	 *
	 * @param time of {@link LocalTime} type.
	...
	/**
	 * Returns the number of seconds from midnight to the given time. If time is
	 * null, null will be returned.
	 *
	 * @param time of {@link LocalTime} type.
	...
	/**
	 * Returns the minutes portion of a time. If time is null, null will be
	 * returned.
	 *
	 * @param time of {@link LocalTime} type.
	...
	/**
	 * Returns the day of the month from the given date. If date is null, null will
	 * be returned.
	 *
	 * @param date of {@link LocalDate} type.
	...
	/**
	 * Returns the month number from the given date. If date is null, null will be
	 * returned.
	 *
	 * @param date of {@link LocalDate} type.
	...
	/**
	 * Returns the date of the specified day of the week soonest after the source
	 * date. The day of the week is specified as the full name, for example,
	 * thursday, or a three-letter abbreviation, for example, thu. If source is
	 * null, null will be returned. If the day of the week is null, source will be
	 * returned.
	 *
	...
	public static LocalDate NextWeekdayFromDate(LocalDate source, String textDayOfWeek) {
		return source == null ? null
				: (textDayOfWeek == null ? source : source.with(TemporalAdjusters.next(getDayOfWeek(textDayOfWeek))));
	}

	/**
	 * Returns the date of the specified day of the week offset by the specified
	 * number of weeks from the source date. The day of the week is specified as the
	 * full name, for example, thursday, or a three-letter abbreviation, for
	 * example, thu. The offset values can be positive, negative, or zero. If source
	 * is null, null will be returned. If textDayOfWeek is null, source will be
	 * returned. If offset is null, it will be treated as 0.
	 *
	 * @param source        of {@link LocalDate} type.
	...
	/**
	 * Returns the date of the specified day of the week that is the most recent day
	 * before the source date. The day of the week is specified as the full name,
	 * for example, thursday, or a three-letter abbreviation, for example, thu. If
	 * source is null, null will be returned. If the day of the week is null, source
	 * will be returned.
	 *
	 * @param source        of {@link LocalDate} type.
	 * @param textDayOfWeek Display week of day string
	...
	public static LocalDate PreviousWeekdayFromDate(LocalDate source, String textDayOfWeek) {
		return source == null ? null
				: (textDayOfWeek == null ? source
						: source.with(TemporalAdjusters.previous(getDayOfWeek(textDayOfWeek))));
	}

	/**
	 * Returns the seconds portion of a time. If time is null, null will be
	 * returned.
	 *
	 * @param time of {@link LocalTime} type.
	...
	/**
	 * Returns the number of seconds between two datetime objects. If either
	 * datetime is null, null will be returned.
	 *
	 ...
	 * given as four separate values. If any input is null, null will be returned.
	 *
	...
	public static LocalTime TimeFromComponents(Integer hours, Integer mins, Integer seconds, Integer microseconds) {
		return hours == null || mins == null || seconds == null || microseconds == null ? null
				: LocalTime.of(hours, mins, seconds, microseconds * 1000);
	}

	/**
	 * Returns the time given the number of seconds since midnight. If seconds is
	 * null, midnight will be returned.
	 *
	...
	/**
	 * Returns the time, with offsets applied from the base time. hour offset,
	 * minute offset, and second offset each given as separate values. The seconds
	 * offset can include partial seconds. If time is null, null will be returned.
	 * If the offset is null, it will be treated as 0.
	 *
	...
	public static LocalTime TimeOffsetByComponents(LocalTime time, Integer hour, Integer min, Integer seconds) {
		return time == null ? null
				: time.plusHours(hour == null ? 0 : hour).plusMinutes(min == null ? 0 : min)
						.plusSeconds(seconds == null ? 0 : seconds);
	}

	/**
	 * Returns a datetime from the given date and time. If any input is null, null
	 * will be returned.
	 *
	...
	/**
	 * Returns a datetime that is derived from the number of seconds from the base
	 * datetime object. If time is null, null will be returned. If seconds is null,
	...
	/**
	 * Returns a datetime from the given epoch time specified in seconds. This
	 * method assumes the timestamp is in UTC time. If timestamp is null, null will
	 * be returned.
	 *
	...
	/**
	 * Returns a datetime from the given time and datetime objects. The value in the
	 * time object overwrites the time value in the datetime object so that only the
	 * date part is used from the datetime. If datetime is null, null will be
	 * returned. If time is null, datetime will be returned.
	 *
	...
	public static LocalDateTime DateTimeFromTime(LocalTime time, LocalDateTime datetime) {
		return datetime == null ? null
				: (time == null ? datetime
						: datetime.withHour(time.getHour()).withMinute(time.getMinute()).withSecond(time.getSecond())
								.withNano(time.getNano()));
	}

	/**
	 * Returns a datetime from the given time and the offsets. If datetime is null,
	 * null will be returned. If offset is null, it will be treated as 0.
	 *
	...
	public static LocalDateTime DateTimeOffsetByComponents(LocalDateTime datetime, Integer yearOffset,
			Integer monthOffset, Integer dayOfMonthOffset, Integer hourOffset, Integer minOffset,
			Integer secondOffset) {
		return datetime == null ? null
				: datetime.plusYears(yearOffset == null ? 0 : yearOffset)
						.plusMonths(monthOffset == null ? 0 : monthOffset)
						.plusDays(dayOfMonthOffset == null ? 0 : dayOfMonthOffset)
						.plusHours(hourOffset == null ? 0 : hourOffset).plusMinutes(minOffset == null ? 0 : minOffset)
						.plusSeconds(secondOffset == null ? 0 : secondOffset);
	}

	/**
	 * @return Returns the datetime, with offsets applied from the base datetime
	 *         with seconds offset. If datetime is null, null will be returned. If
	 *         seconds is null, it will be treated as 0.
	 */
	...
	/**
	 * @return Returns a UNIX epoch time in seconds from the given datetime in UTC
	 *         time. If datetime is null, null will be returned.
	 */
	...
	/**
	 * @return Returns a UNIX epoch time in seconds from the given timestamp in UTC
	...
	/**
	 * @return Returns the day number of the week from the given date with start of
	 *         week provided. If date is null, null will be returned. If startOfWeek
	 *         is null, the date's day number of the week will be returned.
	 */
	public static Integer WeekdayFromDate(LocalDate date, String startOfWeek) {
		...
		int daysInWeek = startOfWeek == null ? date.getDayOfWeek().getValue()
				: date.with(TemporalAdjusters.previousOrSame(DayOfWeek.valueOf(startOfWeek.toUpperCase())))
						.getDayOfWeek().getValue();
		return 7 - daysInWeek + 1;
	}

	/**
	 * @return Returns the day number of the week from the given date. If date is
	 *         null, null will be returned.
	 */
	...
	/**
	 * @return Returns the day number in the year from the given date. If date is
	 *         null, null will be returned.
	 */
	...
	/**
	 * @return Returns the year from the given date. If date is null, null will be
	 *         returned
	 */
	...
	/**
	 * @return Returns the week number in the year from the given date. If date is
	 *         null, null will be returned.
	 */
	public static Integer YearweekFromDate(LocalDate date) {
		...
		return date == null ? null : date.get(WeekFields.of(DayOfWeek.MONDAY, 7).weekOfWeekBasedYear());
	}
}
